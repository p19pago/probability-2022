...
int main(int argc, char** argv){
	...
	//for the main file "walkers_lab8.txt" 
	//they are printed after the loop
	
	fprintf(fp, "%d\n", pos1);
	fprintf(fp, "%d\n", pos2);
	
	//for the file "walkers1_lab8.txt", addressed to position 1 separately.
	//it is printed after the loop
	
	fprintf(fp1, "%d\n", pos1);
	
	//for the file "walkers2_lab8.txt", addressed to position 2 separately.
	//it is printed after the loop
